...
render_complete_report <- function (file, 
  ...
  rmarkdown_render(here::here("code", "report_app.Rmd"), output_file = file)
}
...
render_dummy_report <- function (file, 
  ...
  summary <- make_summary(gene_symbol, 
                          ...
                          summary1, 
                          summary2)
  rmarkdown_render(here::here("code", "report_dummy_app.Rmd"), output_file = file)
}
...
rmarkdown_render <- function (input, output_file){
  tmpdir <- tempdir()
