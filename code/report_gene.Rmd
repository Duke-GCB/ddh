...
```{r expression_plot, echo=FALSE, message=FALSE, warning=FALSE}
expression_plot
```
  
**`r plot_cellexp_title`** `r plot_cellexp_legend`  
  
```{r expression_table, echo=FALSE, message=FALSE, warning=FALSE}
expression_table %>% 
  slice(1:15) %>% 
...
\newpage  
## GGraph Network Graph of `r summary$identifier`
